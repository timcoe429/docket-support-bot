...
const TOOLS = [
    ...
    {
        name: "lookup_project",
        description: "Look up a client's website build project by their business name. Returns current build stage, domain access status, and other project details from our project management board. Use this when a client asks about their website build status and you have their business name.",
        input_schema: {
            type: "object",
            properties: {
                company_name: {
